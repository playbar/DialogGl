...
int gg_strnicmp(const char* first, const char* last, int count)
{
	//if (len == 0) len = 0xfffff;
	//if (lhs == 0)
	//{
...
int gg_stricmp(const char* dst, const char* src)
{
	int f, l;
...
int gg_wcsnicmp(const unsigned short* first, const unsigned short* last, int count)
{
	//if (len == 0) len = 0xfffff;
	//if (lhs == 0)
	//{
...
int gg_wcsicmp(const unsigned short* dst, const unsigned short* src)
{
	int f, l;
